      ...
      <MDBContainer className="text-center text-md-left">
        <MDBRow className="text-center text-md-left mt-3 pb-3">
          ...
          <MDBCol md="2" lg="2" xl="2" className="mx-auto mt-3">
            <h6 className="text-uppercase mb-4 font-weight-bold"><strong>Books</strong></h6>
            <p>
              <a href="#">Lorem</a>
            </p>
            <p>
          ...
          <MDBCol md="4" lg="3" xl="3" className="mx-auto mt-3">
            ...
            <p>
              <i className="fa fa-phone mr-3" /> +216 52 264 360
            </p>
            <p>
              <i className="fa fa-home mr-3" /> Tunis, Tunisie
            </p>
          </MDBCol>
        </MDBRow>
        <hr />
